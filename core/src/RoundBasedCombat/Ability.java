...
public abstract class Ability {
    ...
    public Ability(String name, String tooltip, AbilityType abilityType, TargetType targetType, SpellType spellType, double missChance, double critChance, int manaCosts) {
        this.name = name;
